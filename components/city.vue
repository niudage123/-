  ...
  export default {
		methods:{
		 citySelected : function(e){
			 console.log(e)
			this.$store.commit('citySelected', 'hi...')
		 }
		}
  }
</script>
		...
		bindAZ: function(e) {
		  ...
		  citySelected: function(e) {
			  ...
			  var cityNameTemp = e.currentTarget.dataset.cityname;
				console.log(cityNameTemp, 'dddddddddd');
				this.$store.commit('setLocation', cityNameTemp);
				this.currentCity = cityNameTemp;
				uni.showToast({title: cityNameTemp,icon:'none'});
				uni.navigateBack({
					// 向上返回一层
						delta: 1
				});
